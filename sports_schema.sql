...
SELECT Description
FROM Therapies
WHERE therapycode IN (SELECT therapycode FROM session WHERE therapistid = 'SW124');

#Question 6
SELECT firstname, lastname
FROM Therapist
WHERE therapistid = (SELECT therapistid FROM session WHERE patientnum = 1014);
...
#Question 10
# I would add the Hourly Rate row in the Therapist Table. This would help 
